<template>
  <div>
    <body class="g-sidenav-show bg-gray-100">
      ...
      <!--<span class="ms-1 font-weight-bold">UMMI LAUNDRY</span>-->
      ...
      >
        <div class="sidenav-header">
          ...
          >
            <img
              src="src/assets/img/png-clipart-washing-machines-graphics-laundry-detergent-symbol-on-washing-machine-clothes-dryer-cleaning-thumbnail-removebg-preview.png"
          ...
          <div class="container-fluid">
            <div class="row align-items-center justify-content-lg-between">
              <div class="col-lg-6 mb-lg-0 mb-4">
                ...
                >
                  © 2022 made with <i class="fa fa-heart"></i> by Yumna Indah
                  for a better web.
                </div>
              </div>
            </div>
